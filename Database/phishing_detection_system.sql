...
--
-- Host: localhost
-- Generation Time: Jan 30, 2024 at 07:13 AM
...
--
CREATE DATABASE IF NOT EXISTS `phishing_detection_system` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `phishing_detection_system`;
...
('cby455qei4smz99ugfp2rejyvaj71c9u', 'eyJ1c2VyaWQiOjN9:1rFEKp:YvVvgz1CfzWLAOI_F9DMMM5AO1bsIU_3xMbbQ1UPp5A', '2024-01-01 14:11:07.902516'),
...
('qsb8jo9ks1mp57w8ojwu0yalbay624ib', 'eyJ1c2VyaWQiOjF9:1rFDSI:cPekA8Ai0f0cGI-3xOPRhhrmzc7YUuathILXN3TIyfE', '2024-01-01 13:14:46.212214'),
...
(71, 'Naive Bayes', '93.29794293297942'),
(72, 'SVM', '96.28400796284008'),
(73, 'Logistic Regression', '95.68679495686794'),
(74, 'Decision Tree Classifier', '96.32824596328246'),
(75, 'Gradient Boosting Classifier', '94.51448794514488'),
(76, 'Random Forest Classifier', '96.12917496129175');
...
(25, 'Phishing URL', '33.33333333333333'),
(26, 'Normal URL', '66.66666666666666');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_phishing_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_phishing_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_phishing_detection`
--

INSERT INTO `remote_user_phishing_detection` (`id`, `url`, `Prediction`) VALUES
(1, 'comingsoon.net/news/movienews.php?id=84803', 'Normal URL'),
(3, 'skclovescollegefootball.wordpress.com/', 'Normal URL'),
(4, 'http://www.veiculoseguro.com.br/index.php?option=com_content&view=article&id=65&Itemid=85', 'Phishing URL'),
(5, 'closinglogos.com/page/DiC+Entertainment', 'Normal URL'),
(6, 'http://www.cuxhaven.cc/index.php?view=category&catid=2&option=com_joomgallery&Itemid=47', 'Phishing URL'),
(7, 'ratemds.com/doctor-ratings/2729112/Dr-ROBERT-WERTHEIMER-WEST-CALDWELL-NJ.html', 'Normal URL');
